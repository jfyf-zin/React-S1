                ...
                <div className="d-flex flex-wrap">
                  {tempProduct.imagesUrl.map((url, index) => (
                    <img
                      ...
                      //重點加入 onClick
                      onClick={() => {
                        // 要使用 setTempProduct 來更新狀態
                        setTempProduct({
                          ...tempProduct, // 1. 把原本產品的所有資料 (title, price...) 都複製一份保留下來
                          imageUrl: url, // 2. 只有「主圖 (imageUrl)」換成現在點擊的這張 (url)
                        });
                      }}
                      style={{
                        width: "200px",
                        height: "150px", // 建議給個固定高度比較整齊
                        objectFit: "cover", // 讓圖片不變形
                        marginRight: "10px",
                        cursor: "pointer", // ★ 加這個，滑鼠移上去會變手指，讓使用者知道可以點
                      }}
                    />
                  ))}
